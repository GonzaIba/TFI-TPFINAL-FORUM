...
{
    /// <inheritdoc />
    public partial class InitialPostgresGateway : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IDFilterType = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    Type = table.Column<string>(type: "varchar(400)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_FilterType", x => x.IDFilterType);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedDate = table.Column<DateTime>(type: "timestamp(7) with time zone", nullable: false, defaultValueSql: "CURRENT_TIMESTAMP"),
                    Active = table.Column<bool>(type: "boolean", nullable: false, defaultValue: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IDFilter = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    Name = table.Column<string>(type: "varchar(50)", nullable: false),
                    Api = table.Column<string>(type: "character varying(50)", unicode: false, maxLength: 50, nullable: false),
                    Description = table.Column<string>(type: "varchar(250)", nullable: false),
                    IDFilterType = table.Column<int>(type: "integer", nullable: false),
                    Options = table.Column<string>(type: "varchar(1000)", nullable: true),
                    Active = table.Column<bool>(type: "boolean", nullable: false, defaultValue: true),
                    CreateDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValueSql: "CURRENT_TIMESTAMP")
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Filter_FilterType_IDFilterType",
                        column: x => x.IDFilterType,
                        principalTable: "FilterType",
                        principalColumn: "IDFilterType",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Publicaciones_Users_UsersId",
                        column: x => x.UsersId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RecompensasUsuario_Users_UsersId",
                        column: x => x.UsersId,
                        principalTable: "Users",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SolicitudAyuda_Users_UsersId",
                        column: x => x.UsersId,
                        principalTable: "Users",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShortDescriptionForum = table.Column<string>(type: "varchar(100)", nullable: true),
                    LongDescriptionForum = table.Column<string>(type: "varchar(500)", nullable: true),
                    ImageForum = table.Column<string>(type: "text", nullable: true),
                    Onboarded = table.Column<bool>(type: "boolean", nullable: false),
                    HasSeenIntroPublications = table.Column<bool>(type: "boolean", nullable: false),
                    HasSeenIntroLabels = table.Column<bool>(type: "boolean", nullable: false),
                    HasSeenIntroUsers = table.Column<bool>(type: "boolean", nullable: false),
                    HasSeenIntroLiveHelp = table.Column<bool>(type: "boolean", nullable: false),
                    LastTimeConnectedForum = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UsersForum", x => x.IdUser);
                    table.ForeignKey(
                        name: "FK_UsersForum_Users_IdUser",
                        column: x => x.IdUser,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UsuariosMedallas_Users_IDUsuario",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PublicacionesGuardadas_Users_IDUsuario",
                        column: x => x.IDUsuario,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PublicacionesVotos_Users_IDUsuario",
                        column: x => x.IDUsuario,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "IDPublicacion");
                    table.ForeignKey(
                        name: "FK_Respuestas_Users_UsersId",
                        column: x => x.UsersId,
                        principalTable: "Users",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "IDSolicitudAyuda");
                    table.ForeignKey(
                        name: "FK_SolicitudAyudaHistorial_Users_UserIdAccion",
                        column: x => x.UserIdAccion,
                        principalTable: "Users",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RespuestasVotos_Users_IDUsuario",
                        column: x => x.IDUsuario,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SolicitudAyudaReserva_Users_IDUsuarioAyudante",
                        column: x => x.IDUsuarioAyudante,
                        principalTable: "Users",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PublicacionesGuardadas_IDUsuario",
                table: "PublicacionesGuardadas",
                column: "IDUsuario");

            migrationBuilder.CreateIndex(
                name: "IX_PublicacionesVotos_IDUsuario",
                table: "PublicacionesVotos",
                column: "IDUsuario");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RecompensasUsuario_UsersId",
                table: "RecompensasUsuario",
                column: "UsersId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Respuestas_UsersId",
                table: "Respuestas",
                column: "UsersId");

            migrationBuilder.CreateIndex(
                name: "IX_RespuestasVotos_IDUsuario",
                table: "RespuestasVotos",
                column: "IDUsuario");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SolicitudAyuda_UsersId",
                table: "SolicitudAyuda",
                column: "UsersId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SolicitudAyudaHistorial_UserIdAccion",
                table: "SolicitudAyudaHistorial",
                column: "UserIdAccion");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UsuariosMedallas_IDUsuario",
                table: "UsuariosMedallas",
                column: "IDUsuario");
        }
