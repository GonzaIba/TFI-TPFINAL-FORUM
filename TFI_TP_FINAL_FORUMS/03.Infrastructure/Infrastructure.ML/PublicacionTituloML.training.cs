...
namespace Infrastructure_ML
{
    public partial class PublicacionTituloML
    {
        ...
        public const string RetrainCommandString = @"SELECT Pregunta, Etiquetas FROM [dbo].[PreguntasPredicciones]";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName: @"Pregunta", outputColumnName: @"Pregunta")
                                    .Append(mlContext.Transforms.Concatenate(@"Features", new[] { @"Pregunta" }))
